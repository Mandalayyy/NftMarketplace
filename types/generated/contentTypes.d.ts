...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    nftsCreated: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::nft.nft'
    >;
    avatar: Attribute.Media<'images'>;
    totalSales: Attribute.Float;
    userPageImg: Attribute.Media<'images'>;
    firstName: Attribute.String;
    lastName: Attribute.String;
    bio: Attribute.Text;
    Balance: Attribute.Integer & Attribute.DefaultTo<0>;
    nftsSold: Attribute.Integer;
...
export interface ApiCollectionCollection extends Schema.CollectionType {
  ...
  attributes: {
    ...
    collectionDescription: Attribute.String;
    nfts: Attribute.Relation<
      'api::collection.collection',
      'oneToMany',
      'api::nft.nft'
    >;
    collectionOwner: Attribute.Relation<
      'api::collection.collection',
      'manyToOne',
      'plugin::users-permissions.user'
    >;
...
export interface ApiNftNft extends Schema.CollectionType {
  ...
  attributes: {
    ...
    nftPrice: Attribute.Decimal;
    nftCreateDate: Attribute.Date;
    nftImg: Attribute.Media<'images'>;
    ...
    collection: Attribute.Relation<
      ...
      'api::collection.collection'
    >;
    nftOwner: Attribute.Relation<
      'api::nft.nft',
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    nft_creator: Attribute.Relation<
      'api::nft.nft',
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    lastBid: Attribute.Float;
    auctionEndDate: Attribute.Date;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
